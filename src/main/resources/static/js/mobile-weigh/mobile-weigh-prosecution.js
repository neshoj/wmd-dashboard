(function ($, window) {
    ...
    $(function () {
        ...
        $form.find('[name="axleClass"]').bind("keyup change", function () {
            $(this).val(function (i, v) {
                return v.toUpperCase();
            });
        });

        $form.find('[name="prohibitionNo"]').bind("keyup change", function () {
            $(this).val(function (i, v) {
                return v.toUpperCase();
            });
        });
        ...
        $form.find('[name="receiptNo"]').bind("keyup change", function () {
            $(this).val(function (i, v) {
                return v.toUpperCase();
            });
        });
