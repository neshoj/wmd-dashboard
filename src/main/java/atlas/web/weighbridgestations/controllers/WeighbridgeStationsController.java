package atlas.web.weighbridgestations.controllers;
...
import atlas.web.weighbridgestations.WeighbridgeStationsServiceInterface;
...
public class WeighbridgeStationsController {
    ...
    private ModelAndView fetchTableInfo(HttpServletRequest request, View view) {
        ...
        String parentType = (String) request.getSession().getAttribute("_userParentType");
            ...
            dataTable
                    .select("a.name, a.stationCode, a.location, a.mobileNo, b.merchantNo, c.name, str(a.createdOn; 'YYYY-MM-DD HH24:MI:SS'), str(a.updatedOn; 'YYYY-MM-DD HH24:MI:SS'), a.id")
                    .from("WeighbridgeStations a LEFT JOIN a.merchantLink b")
                    .from("WeighbridgeStations a LEFT JOIN a.axleConfigurationGroupLink c")
                    .where("a.flag = :flag ")
